 ...
 * \brief Permet de choisir un point ‡ atteindre
 * 
 * \param pos Position ‡ atteindre
 */
 ...
 * \brief Permet de choisir un point en x ‡ atteindre
 * 
 * @param x Point en x ‡ atteindre
 */
 ...
 * \brief Permet de choisir un point en y ‡ atteindre
 * 
 * @param x Point en y ‡ atteindre
 */
 ...
 * \brief Permet de choisir un angle ‡ atteindre
 * 
 * @param x Valeur de l'angle ‡ atteindre
 */
 ...
 * \brief Permet de choisir une vitesse linÈaire max
 * 
 * \param vl_max vitesse linÈaire max
 */
 ...
 * \brief Permet de choisir une accÈleration max
 * 
 * \param al_max accÈleration linÈaire max
 * \param at_max accÈleration angulaire max
 * \param a_max accÈlÈration max
 */
